 ...
 *
 *         Menu du préposé utilisé pour l'ajout d'un client. Le menu ce ferme
 *         que lorsque le préposé annule l'ajout d'un client ou lorsqu'il
 *         confirme l'ajout d'un client.
 * 
...
public class GUI_AjoutClient extends GUI {
	...
	public GUI_AjoutClient(GUI upperMenu) {
		...
		if (labelNoCBFont != null)
			labelCB.setFont(labelNoCBFont);
		...
		if (textFieldNomFont != null)
			textFieldNom.setFont(textFieldNomFont);
		gbc = new GridBagConstraints();
		gbc.gridx = 9;
		gbc.gridy = 1;
		gbc.gridwidth = 2;
		...
		if (labelNomFont != null)
			labelNom.setFont(labelNomFont);
		...
		if (textFieldPrenomFont != null)
			textFieldPrenom.setFont(textFieldPrenomFont);
		gbc = new GridBagConstraints();
		gbc.gridx = 9;
		gbc.gridy = 2;
		gbc.gridwidth = 2;
		...
		if (labelPrenomFont != null)
			labelPrenom.setFont(labelPrenomFont);
		...
		if (textFieldAdresseFont != null)
			textFieldAdresse.setFont(textFieldAdresseFont);
		...
		if (labelAdresseFont != null)
			labelAdresse.setFont(labelAdresseFont);
		labelAdresse.setHorizontalAlignment(0);
		labelAdresse.setHorizontalTextPosition(0);
		labelAdresse.setText("Adresse : ");
		labelAdresse.setToolTipText(
				"Inserer en respectant le format numéro de maison, direction de rue, nom de rue, ville, province, ZipCode, pays");
		gbc = new GridBagConstraints();
		gbc.gridx = 1;
		gbc.gridy = 3;
		gbc.anchor = GridBagConstraints.EAST;
		...
		if (labelTelFont != null)
			labelTel.setFont(labelTelFont);
		...
		if (formattedTextFieldTelDomFont != null)
			formattedTextFieldTelDom.setFont(formattedTextFieldTelDomFont);
		gbc = new GridBagConstraints();
		gbc.gridx = 9;
		gbc.gridy = 5;
		gbc.gridwidth = 2;
		...
		if (formattedTextFieldTelMobFont != null)
			formattedTextFieldTelMob.setFont(formattedTextFieldTelMobFont);
		gbc = new GridBagConstraints();
		gbc.gridx = 9;
		gbc.gridy = 6;
		gbc.gridwidth = 2;
		...
		if (formattedTextFieldNoPermisFont != null)
			formattedTextFieldNoPermis.setFont(formattedTextFieldNoPermisFont);
		gbc = new GridBagConstraints();
		gbc.gridx = 9;
		gbc.gridy = 7;
		gbc.gridwidth = 2;
		...
		if (labelNoPermisFont != null)
			labelNoPermis.setFont(labelNoPermisFont);
		...
		if (labelTelMobFont != null)
			labelTelMob.setFont(labelTelMobFont);
		...
		if (labelTelDomFont != null)
			labelTelDom.setFont(labelTelDomFont);
		...
		if (passwordFieldCBFont != null)
			passwordFieldCB.setFont(passwordFieldCBFont);
		gbc = new GridBagConstraints();
		gbc.gridx = 10;
		gbc.gridy = 8;
		gbc.anchor = GridBagConstraints.WEST;
	...
	private void confirmerAjoutButtonClick() {
		Registre.creationClient(this, textFieldNom.getText(), textFieldPrenom.getText(), textFieldAdresse.getText(),
				formattedTextFieldTelDom.getText(), formattedTextFieldTelMob.getText(),
				formattedTextFieldNoPermis.getText(), passwordFieldCB.getText());
	}
